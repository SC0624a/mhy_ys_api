...
```curl
curl -X GET 'https://api-takumi-record.mihoyo.com/game_record/app/genshin/api/dailyNote?role_id=XXX&server=cn_gf01' -H 'User-Agent: Mozilla/5.0 (Linux; Android 12; 2211133C Build/V417IR; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.154 Safari/537.36 miHoYoBBS/2.102.1' -H 'Accept: application/json, text/plain, */*' -H 'Accept-Encoding: gzip, deflate' -H 'DS: 1772522222,113585,01de9859b0c231e9c2b912b4d9f426da' -H 'x-rpc-app_version: 2.102.1' -H 'x-rpc-tool_verison: v6.4.0-gr-cn' -H 'x-rpc-device_id: 40818f2a-2395-38df-ab11-93371b77324e' -H 'x-rpc-device_name: Xiaomi%202211133C' -H 'x-rpc-page: v6.4.0-gr-cn_#/ys/daily' -H 'x-rpc-device_fp: 38d816239aab3' -H 'x-rpc-sys_version: 12' -H 'x-rpc-client_type: 5' -H 'Origin: https://webstatic.mihoyo.com' -H 'X-Requested-With: com.mihoyo.hyperion' -H 'Sec-Fetch-Site: same-site' -H 'Sec-Fetch-Mode: cors' -H 'Sec-Fetch-Dest: empty' -H 'Referer: https://webstatic.mihoyo.com/' -H 'Accept-Language: zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7' -H 'Cookie: XXX'
```
</details>

**请求方式：GET**

> 链接：`https://api-takumi-record.mihoyo.com/game_record/app/genshin/api/dailyNote`
...
```json
{
  ...
  "data": {
    ...
    "expeditions": [
      {
        "avatar_side_icon": "https://fastcdn.mihoyo.com/static-resource-v2/2023/12/14/a273217a806ee130b0c0f51bc5542483_2404530785826539052.png",
        "status": "Finished",
        "remained_time": "0"
      },
      {
        "avatar_side_icon": "https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/67c7f727/a61ccec5064fe90c87ed3257bc194b19.png",
        "status": "Finished",
        "remained_time": "0"
      },
      {
        "avatar_side_icon": "https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/67c7f727/455ee1e4da29c15282faba8243bccdcc.png",
        "status": "Finished",
        "remained_time": "0"
      },
      {
        "avatar_side_icon": "https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/67c7f727/db95c5527a3b0f1a59743180e531be63.png",
        "status": "Finished",
        "remained_time": "0"
      },
      {
        "avatar_side_icon": "https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/67c7f727/efda18cb3e43ffbbb8355b54417f05b6.png",
        "status": "Finished",
        "remained_time": "0"
      }
    ],
    ...
    "calendar_url": "https://baike.mihoyo.com/ys/obc/channel/map/193?bbs_presentation_style=no_header",
    "transformer": {
      "obtained": true,
      "recovery_time": {
        "Day": 0,
      ...
      "wiki": "https://baike.mihoyo.com/ys/obc/content/1562/detail?bbs_presentation_style=no_header",
      "noticed": false,
      "latest_job_id": "0"
    },
    "daily_task": {
      ...
      "stored_attendance": "328.9",
      "stored_attendance_refresh_countdown": 2522444587
    },
    "archon_quest_progress": {
      ...
      "wiki_url": "https://baike.mihoyo.com/ys/obc/content/399/detail?bbs_presentation_style=no_header"
    }
  }
}
```
